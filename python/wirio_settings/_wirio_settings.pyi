...
class AzureKeyVaultSettingsSource(SettingsSource):
    def __new__(cls, /, url: str, client_id: str |None = None, client_secret: str |None = None, tenant_id: str |None = None) -> AzureKeyVaultSettingsSource: ...
    def build(self, /) -> SettingsProvider: ...
...
class SettingsProvider:
    ...
    def data(self, /) -> dict[str, str |None]: ...
    def load_sync(self, /) -> None: ...
    def try_get(self, /, _key: str) -> SettingLookup: ...
